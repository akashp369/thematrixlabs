...
import '../styles/TokenComp.css'
import DetailComp from './DetailComp';
import '../styles/DetailComp.css';
...
const TokenComp = () => {
  ...
  return (
    <div style={{height:"80vh", overflow:"auto"}}>
      ...
      (<h3 style={{margin:"auto",marginTop:"2rem" ,color:"#631158", backgroundColor:"white", fontSize:"1rem"}}>Search Token is <br/> 0x2170Ed0880ac9A755fd29B2688956BD959F933F8</h3>)
      }
    </div>
  )
}
